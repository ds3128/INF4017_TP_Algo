...
{
    int taille = 0;
    cout << "Entrez le degre des polynomes : " <<endl;
    cin >> taille;
    ...
    int i=0;
    cout << "remplir premier polynome.." << endl;

    for(i = 0; i <= taille; i++)
    {
        cout << "coefficient monome " << (i+1) << ": ";
        cin >> P[i];
        cout << endl;
    }

    cout << "remplir deuxieme polynome.." << endl;
    for(i = 0; i <= taille; i++){
        cout << "coefficient du monome " << (i+1) << ": ";
        cin >> Q[i];
        cout << endl;
    }
    cout << "affichage polynome P: " << endl;
    affichage(P, taille);
    cout << endl;
    cout << "affichage polynome Q: " << endl;
    affichage(Q, taille);
    cout << endl;

    P = Karatsuba(P, Q, taille);
    affichage(P, 2*taille);
}
